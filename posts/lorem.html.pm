...
◊tsection[#:label 'begin]{My first section}

◊tsubsection[#:label 'lorem]{My first subsection}
...
I can also link to ◊ref['final]{another section}, even to ◊ref['finalsub]{another subsection!}. How ◊em{cool} is that? I can also ◊ref['begin]{backwards}.
...
◊tsection[#:label 'final]{Our final section!}
...
◊tsubsection[#:label 'finalsub]{My last subsection}
