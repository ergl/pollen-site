...
◊ul{
    ...
    ◊li{◊l["https://github.com/ergl/clojurebot" #:ext #t]{clojurebot} – A Clojure REPL for Telegram Messenger.}
...
All posts licensed under a ◊l["http://creativecommons.org/licenses/by-nc-sa/4.0/" #:ext #t]{CC BY-NC-SA 4.0}.
